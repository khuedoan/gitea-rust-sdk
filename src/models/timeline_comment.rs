...
pub struct TimelineComment {
    ...
    pub label: Option<Box<models::Label>>,
    ...
    pub old_milestone: Option<Box<models::Milestone>>,
    ...
    pub ref_comment: Option<Box<models::Comment>>,
    ...
    pub ref_issue: Option<Box<models::Issue>>,
    ...
    pub resolve_doer: Option<Box<models::User>>,
    ...
    pub tracked_time: Option<Box<models::TrackedTime>>,
