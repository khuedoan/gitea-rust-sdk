...
pub async fn get_general_api_settings(configuration: &configuration::Configuration, ) -> Result<crate::models::GeneralApiSettings, Error<GetGeneralApiSettingsError>> {
...
pub async fn get_general_attachment_settings(configuration: &configuration::Configuration, ) -> Result<crate::models::GeneralAttachmentSettings, Error<GetGeneralAttachmentSettingsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_general_repository_settings(configuration: &configuration::Configuration, ) -> Result<crate::models::GeneralRepoSettings, Error<GetGeneralRepositorySettingsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_general_ui_settings(configuration: &configuration::Configuration, ) -> Result<crate::models::GeneralUiSettings, Error<GetGeneralUiSettingsError>> {
    let local_var_configuration = configuration;
