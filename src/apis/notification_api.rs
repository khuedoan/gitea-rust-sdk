...
pub async fn notify_get_list(configuration: &configuration::Configuration, all: Option<bool>, status_types: Option<Vec<String>>, subject_type: Option<Vec<String>>, since: Option<String>, before: Option<String>, page: Option<i32>, limit: Option<i32>) -> Result<Vec<crate::models::NotificationThread>, Error<NotifyGetListError>> {
...
pub async fn notify_get_thread(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::NotificationThread, Error<NotifyGetThreadError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_new_available(configuration: &configuration::Configuration, ) -> Result<crate::models::NotificationCount, Error<NotifyNewAvailableError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_read_list(configuration: &configuration::Configuration, last_read_at: Option<String>, all: Option<&str>, status_types: Option<Vec<String>>, to_status: Option<&str>) -> Result<Vec<crate::models::NotificationThread>, Error<NotifyReadListError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_read_repo_list(configuration: &configuration::Configuration, owner: &str, repo: &str, all: Option<&str>, status_types: Option<Vec<String>>, to_status: Option<&str>, last_read_at: Option<String>) -> Result<Vec<crate::models::NotificationThread>, Error<NotifyReadRepoListError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_read_thread(configuration: &configuration::Configuration, id: &str, to_status: Option<&str>) -> Result<crate::models::NotificationThread, Error<NotifyReadThreadError>> {
    let local_var_configuration = configuration;
