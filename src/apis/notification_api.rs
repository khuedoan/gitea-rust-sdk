...
pub async fn notify_get_list(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<models::NotificationThread>, Error<NotifyGetListError>> {
...
pub async fn notify_get_repo_list(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<models::NotificationThread>, Error<NotifyGetRepoListError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_get_thread(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::NotificationThread, Error<NotifyGetThreadError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_new_available(
    configuration: &configuration::Configuration,
) -> Result<models::NotificationCount, Error<NotifyNewAvailableError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<models::NotificationThread>, Error<NotifyReadListError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_read_repo_list(
    ...
    to_status: Option<&str>,
    last_read_at: Option<String>,
) -> Result<Vec<models::NotificationThread>, Error<NotifyReadRepoListError>> {
    let local_var_configuration = configuration;
...
pub async fn notify_read_thread(
    ...
    id: &str,
    to_status: Option<&str>,
) -> Result<models::NotificationThread, Error<NotifyReadThreadError>> {
    let local_var_configuration = configuration;
