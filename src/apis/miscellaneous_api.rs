...
pub async fn get_node_info(configuration: &configuration::Configuration, ) -> Result<crate::models::NodeInfo, Error<GetNodeInfoError>> {
...
pub async fn render_markdown(configuration: &configuration::Configuration, body: Option<crate::models::MarkdownOption>) -> Result<String, Error<RenderMarkdownError>> {
    let local_var_configuration = configuration;
