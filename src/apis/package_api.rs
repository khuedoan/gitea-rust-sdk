...
pub async fn delete_package(configuration: &configuration::Configuration, owner: &str, _type: &str, name: &str, version: &str) -> Result<(), Error<DeletePackageError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/packages/{owner}/{type}/{name}/{version}", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), type=crate::apis::urlencode(_type), name=crate::apis::urlencode(name), version=crate::apis::urlencode(version));
...
pub async fn get_package(configuration: &configuration::Configuration, owner: &str, _type: &str, name: &str, version: &str) -> Result<crate::models::Package, Error<GetPackageError>> {
    let local_var_configuration = configuration;
...
pub async fn list_package_files(configuration: &configuration::Configuration, owner: &str, _type: &str, name: &str, version: &str) -> Result<Vec<crate::models::PackageFile>, Error<ListPackageFilesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/packages/{owner}/{type}/{name}/{version}/files", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), type=crate::apis::urlencode(_type), name=crate::apis::urlencode(name), version=crate::apis::urlencode(version));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_packages(configuration: &configuration::Configuration, owner: &str, page: Option<i32>, limit: Option<i32>, _type: Option<&str>, q: Option<&str>) -> Result<Vec<crate::models::Package>, Error<ListPackagesError>> {
    let local_var_configuration = configuration;
