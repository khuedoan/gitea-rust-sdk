...
) -> Result<crate::models::Organization, Error<AdminCreateOrgError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_create_public_key(
    configuration: &configuration::Configuration,
    username: &str,
    key: Option<crate::models::CreateKeyOption>,
) -> Result<crate::models::PublicKey, Error<AdminCreatePublicKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_create_repo(
    configuration: &configuration::Configuration,
    username: &str,
    repository: crate::models::CreateRepoOption,
) -> Result<crate::models::Repository, Error<AdminCreateRepoError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_create_user(
    configuration: &configuration::Configuration,
    body: Option<crate::models::CreateUserOption>,
) -> Result<crate::models::User, Error<AdminCreateUserError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_cron_list(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<crate::models::Cron>, Error<AdminCronListError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_edit_user(
    configuration: &configuration::Configuration,
    username: &str,
    body: Option<crate::models::EditUserOption>,
) -> Result<crate::models::User, Error<AdminEditUserError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_get_all_orgs(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<crate::models::Organization>, Error<AdminGetAllOrgsError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_get_all_users(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<crate::models::User>, Error<AdminGetAllUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminGetAllUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
