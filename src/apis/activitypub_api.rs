...
pub async fn activitypub_person(configuration: &configuration::Configuration, username: &str) -> Result<crate::models::ActivityPub, Error<ActivitypubPersonError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/activitypub/user/{username}", local_var_configuration.base_path, username=crate::apis::urlencode(username));
...
pub async fn activitypub_person_inbox(configuration: &configuration::Configuration, username: &str) -> Result<(), Error<ActivitypubPersonInboxError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/activitypub/user/{username}/inbox", local_var_configuration.base_path, username=crate::apis::urlencode(username));
