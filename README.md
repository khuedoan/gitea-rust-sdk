...
- API version: 1.18.0+dev-283-gefaa9958b
- Package version: 1.18.0+dev-283-gefaa9958b
- Build package: `org.openapitools.codegen.languages.RustClientCodegen`

## Installation

Put the package under your project folder in a directory named `gitea-sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
gitea-sdk = { path = "./gitea-sdk" }
```
