...
- API version: 1.22.0+dev-892-g9de5e39e2
- Package version: 1.22.0+dev-892-g9de5e39e2
- Build package: `org.openapitools.codegen.languages.RustClientCodegen`

## Installation

Put the package under your project folder in a directory named `gitea` and add the following to `Cargo.toml` under `[dependencies]`:
